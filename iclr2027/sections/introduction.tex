...
\begin{itemize}
    ...
    \item We introduce a rejected-side masking family that includes vanilla DPO, prefix-masked DPO, first-error-only DPO, and \cmdpo{} as weight choices.
