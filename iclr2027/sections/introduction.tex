...
\begin{itemize}
    ...
    \item We add diagnostic controls for suffix schedules, truncated rejected responses, and off-by-one localization noise, clarifying when the masking mechanism succeeds and when it fails.
\end{itemize}
